...
def parse_opt():
    ...
    parser.add_argument('--anno_json', type=str, default='datat.json', help='training model path')
    parser.add_argument('--pred_json', type=str, default='runs/val/exp18/predictions.json', help='data yaml path')
